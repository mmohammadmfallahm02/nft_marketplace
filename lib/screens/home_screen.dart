...
class HomeScreen extends StatelessWidget {
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(7.81)),
                    ),
                    child: Image.asset(Assets.icons.ethereumIcon.path),
                  ),
                  const Text(
                    '0.53',
                  ...
                  const Text('Floor Price',
                      style: MyTextStyle.homeHeaderItemDescription),
                ],
              ),
            ),
          ),
          _buildHeaderItemsColumn(),
        ],
      ),
    );
  }

  Widget _buildHeaderItemsColumn() {
    return Column(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        const SizedBox(
          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                Text('Owners', style: MyTextStyle.homeHeaderItemDescription),
              ],
            ),
          ),
        ),
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                '9.9k',
                style: MyTextStyle.homeHeaderItem.copyWith(
                  color: const Color(0xff262A2F),
                ),
              ),
              Text(
                'Items',
                style: MyTextStyle.homeHeaderItemDescription.copyWith(
                  color: const Color(0x80262A2F),
                ),
              ),
            ],
          ),
          ...
          itemBuilder: (context, index) {
            switch (index) {
              ...
              default:
                ...
                return _buildModelContainer(context, model);
            }
          },
        ),
      ),
  ...
  Widget _buildModelContainer(BuildContext context, NftModel model) {
    return Align(
