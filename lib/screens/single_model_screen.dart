...
class SingleModelScreen extends StatelessWidget {
        ...
        Row(
          ...
          children: [
            GradientBorder(
              ...
              strokeWidth: 1,
              radius: 42,
              child: _buildHighestBidContainer(),
            ),
            GradientBorder(
              gradient: const LinearGradient(
        ...
        Padding(
          ...
          child: SlideAction(
            ...
            thumbBuilder:
              ...
              return _buildBidThumbContainer();
            },
            stretchThumb: false,
            trackBuilder: (context, state) {
              return _buildBidTrackContainer(state, context);
            },
          ),
        )
      ],
  ...
  Widget _buildHighestBidContainer() {
    return Container(
      width: 194,
      height: 230,
      decoration: const BoxDecoration(
      ...
      child: Container(
        ...
        child: BackdropFilter(
          ...
          child: Column(
            ...
            children: [
              const Text('Owner',
                  style: TextStyle(fontSize: 14, color: Color(0x804D4F51))),
  ...
  Widget _buildBidThumbContainer() {
    return Container(
      ...
      child: Center(child: SvgPicture.asset(Assets.icons.placebidIcon)),
    );
  }

  Widget _buildBidTrackContainer(
      SlideActionStateMixin state, BuildContext context) {
    return Container(
      decoration: BoxDecoration(
